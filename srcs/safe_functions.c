...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/07 00:31:56 by lseghier          #+#    #+#             */
/*   Updated: 2024/04/07 02:56:39 by lseghier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	safe_thread_handle(pthread_t *thread, void *(*dinsim)(void *),
		void *data, t_opcode opcode)
{
	if (opcode == CREATE)
		handle_thread_error(pthread_create(thread, NULL, dinsim, data), opcode);
	else if (opcode == JOIN)
